...
class Walkthrough_3 extends StatelessWidget {
  const Walkthrough_3({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text(('Unbeatable Support'),
                      style: Theme.of(context).textTheme.headline1,
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(top: 30,left: 20,right: 10),
                    child: Text(('Send money to other sutraq users free of charge, with no additional fee.'),
